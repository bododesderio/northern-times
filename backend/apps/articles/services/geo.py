...
GAZETTEER: dict[str, Tuple[float, float]] = {
    ...
    'kyankwanzi': (1.0300, 31.7700), 'kiboga': (0.9160, 31.7710), 'nakaseke': (0.7830, 32.4200),
    'sembabule': (0.0640, 31.4570), 'rakai': (-0.7060, 31.4060), 'kyotera': (-0.6180, 31.5140),
    'bombo': (0.5830, 32.5330), 'njeru': (0.4460, 33.1200), 'nansana': (0.3600, 32.5290),
    'kira': (0.4020, 32.6400), 'makindye': (0.2830, 32.5900), 'nakawa': (0.3320, 32.6170),
    'kawempe': (0.3860, 32.5560), 'rubaga': (0.3040, 32.5520), 'kansanga': (0.2900, 32.6060),
    # East
