...
class Command(BaseCommand):
    ...
    def _seed_crawl_sources(self, categories):
        ...
        sources = [
            ...
            {
                'name': 'Daily Monitor',
                'url': 'https://www.monitor.co.ug/uganda/rss',
                'region': 'ugandan',
                'category': 'national',
            ...
            # Sports
            {
                ...
                'url': 'http://feeds.bbci.co.uk/sport/africa/rss.xml',
                'region': 'international',
                'category': 'sports',
                'strip_selectors': '.ads,.sidebar,.social-share',
            ...
            {
                'name': 'KickOff',
                'url': 'https://www.kickoff.com/rss/feed.xml',
                'region': 'international',
                'category': 'sports',
                'strip_selectors': '.ads,.sidebar,.social-share',
