  ...
  <div class="lp-right">
    <div class="lp-form-wrap">
      <div class="lp-form-header">
        <h1 class="lp-form-title">Set new password</h1>
        <p class="lp-form-sub">Choose a strong password (minimum 8 characters)</p>
      </div>
      ...
      <form method="POST" action="/admin/reset-password/<?= h($resetToken) ?>" class="lp-form">
        <input type="hidden" name="_csrf" value="<?= h($csrfToken) ?>">

        <div class="lp-field">
          <label for="rpPassword" class="lp-label">New password</label>
          <input id="rpPassword" name="password" type="password" required
                 autocomplete="new-password" placeholder="••••••••" class="lp-input" minlength="8" autofocus>
        </div>

        <div class="lp-field">
          <label for="rpConfirm" class="lp-label">Confirm password</label>
          <input id="rpConfirm" name="password_confirmation" type="password" required
                 autocomplete="new-password" placeholder="••••••••" class="lp-input" minlength="8">
        </div>
